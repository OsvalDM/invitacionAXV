...
ScrollReveal().reveal('.containerConfirmation__containerImg', {duration: 1200,distance: '80px',delay:400});
ScrollReveal().reveal('.containerConfirmation__iframe', {duration: 1200,distance: '50px',delay:400});
